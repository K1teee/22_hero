...
void CAN_COMM_XYZ(int16_t X,int16_t Y,int16_t Z,int16_t IMU_Y)//X，Y，Z，IMU_Y
{
...
//void CAN_COMM_num(int16_t num)//无力
//{
//    uint32_t send_mail_box;
//    NUM_tx_message.StdId = 0x003;
//    NUM_tx_message.IDE = CAN_ID_STD;
//    NUM_tx_message.RTR = CAN_RTR_DATA;
//    NUM_tx_message.DLC = 0x08;
//    TY_can_send_data[0] = 0;
//    TY_can_send_data[1] = 0;
//    TY_can_send_data[2] = num >> 8;
//    TY_can_send_data[3] = num;
//    TY_can_send_data[4] = 0;
//    TY_can_send_data[5] = 0;
//    TY_can_send_data[6] = 0;
//    TY_can_send_data[7] = 0;
//    watch_can_comm = HAL_CAN_AddTxMessage(&hcan2, &NUM_tx_message, TY_can_send_data, &send_mail_box);
//}
...
//int16_t INA;
//int mode_select(RC_ctrl_t *rc_data)
//{
//	static int flag,num,s;
//	 if(flag == 0 && rc_data->rc.ch[1] < -400.0f)
//    {
//        num++;
//		flag = 1;
//    }
//	if(rc_data->rc.ch[1] > -400.0f)
//	{
//		flag = 0;
//	}
////    if(num%2 != 0)
